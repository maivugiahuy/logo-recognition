...
Output: data/processed/openlogodet3k/splits/open_{train,val,test}.json
        data/processed/openlogodet3k/splits/closed_{train,val,test}.json
"""
import json
import random
...
SPLITS_DIR = Path("data/processed/openlogodet3k/splits")
SEED = 42
TRAIN_FRAC = 0.64
VAL_FRAC = 0.16
# test = remaining 0.20
